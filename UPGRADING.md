...
- The safe upgrade unit today is a tagged release, for example `v2026.03.13 -> v2026.03.20`.
...
pnpm upgrade:diff -- --from v2026.03.13 --to v2026.03.20
```
...
diff -ru ../aither-v2026.03.13 ../aither-v2026.03.20
```

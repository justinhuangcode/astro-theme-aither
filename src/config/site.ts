...
export const siteConfig = defineAitherSiteConfig({
  ...
  directoryHeolink: {
    indexTitle: '',
    siteTitle: 'Heo的生活导航',
    siteSubtitle: '分享有趣的站点',
    indexIcp: '',
    indexIcp2: '',
    searchEngine: '',
    searchPlaceholder: '输入搜索内容...',
    iconApi: 'https://api.zhheo.com/favicon/get.php?url={url}',
    consoleHref: '',
    consoleTitle: '管理后台',
    backgroundColor: '#f2f2f2',
    showCoverImage: true,
    coverImage: '/directory/heolink/images/index_cover2.jpg',
    logoImage: '/directory/heolink/upload/logo_cover.png',

...
Después, el workflow incluido compilará y desplegará automáticamente en cada push a `main`.
...
Este proyecto usa [CalVer](https://calver.org/) con el formato `YYYY.0M.0D`.

...
category: Design
description: Un tema Astro nativo para IA que cree que el texto en si mismo es hermoso.
tags: [Design, Astro]
pinned: false
---

Un tema Astro nativo para IA que cree que el texto en si mismo es hermoso. Astro-Theme-Aither esta construido para lectores que vienen por las palabras, no por la decoracion.

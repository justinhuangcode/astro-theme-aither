...
在 `src/content/posts/en-US/` 下创建一个新的 `.mdx` 文件：
...
```
src/content/posts/en-US/my-post.mdx      # 英文原文
src/content/posts/zh-CN/my-post.mdx  # 中文翻译
src/content/posts/fr-FR/my-post.mdx       # 法文翻译
```
...
**第 4 步**——在 `src/content/translations/en-US/` 中创建内容：

...
Questo e un tema blog costruito su una convinzione: la buona scrittura merita una buona tipografia. Titoli in serif, un ritmo di lettura pulito e una struttura della pagina che non si mette in mezzo. Tutto qui serve un unico obiettivo: far apparire e percepire le tue parole come belle.

## Perche un altro tema blog

Il web e pieno di temi blog, quindi una domanda legittima e: perche costruirne un altro? La risposta sta nelle priorita. La maggior parte dei temi ottimizza per l'impatto visivo — grandi immagini in evidenza, strutture di pagina complesse e transizioni animate. Sono splendidi in una dimostrazione ma intralciano quando qualcuno si siede a leggere un articolo di 2.000 parole.
...
6. **Distribuisci** — pusha su GitHub e lascia che il flusso CI incluso gestisca il deploy su Cloudflare Pages
...
- **Cloudflare Pages** — flusso di deploy con URL di anteprima automatiche per le PR

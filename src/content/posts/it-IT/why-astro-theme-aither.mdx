...
category: Design
description: Un tema Astro nato per l IA che crede che il testo stesso sia bello.
tags: [Design, Astro]
pinned: false
---

Un tema Astro nato per l IA che crede che il testo stesso sia bello. Astro-Theme-Aither e costruito per lettori che vengono per le parole, non per la decorazione.

## Filosofia del design

La maggior parte dei temi blog competono per l'attenzione con immagini in evidenza, animazioni, barre laterali e popup. Nessuno di questi aiuta la lettura — aiutano a guardare, che e un'attivita completamente diversa.
...
- **Cloudflare Pages** — flusso di deploy con URL di anteprima per PR

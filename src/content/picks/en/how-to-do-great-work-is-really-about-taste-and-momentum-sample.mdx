...
That is also why this piece belongs in a `Picks` section instead of a normal blog roll. It is not here because it is new. It is here because it remains useful after the first read.

...
export const IconPalette = createStrokeIcon(
  'IconPalette',
  <>
    <path d="M12 3a9 9 0 0 0 0 18h1.2a2.3 2.3 0 0 0 0-4.6H12a1.9 1.9 0 0 1 0-3.8h1.7A4.3 4.3 0 0 0 18 8.3 5.3 5.3 0 0 0 12 3Z" />
